...
?>    
    ...
    <div class="main" id="section1">
        <h1 style="text-align:center;">Lista Carrelli</h1>
        <a href="#section2" style="text-align:center;"> Clicca qui per visualizzare i prodotti più venduti </a>
    </div>
    <?php
    if(!$con) {
...
<div class="main" id="section2">
    <h1 style="text-align:center;">Lista prodotti più Venduti</h1>
    <a href="#section1" > Clicca qui per andare alla lista dei carrelli </a>
    </div>
<br><br>
    <?php

    //Visualizzare le rendite di vendita
    if(!$con) {
        die("cannot connect to server");
    }

    $sql2 = "SELECT contenuto_carrelli.idprodotto, titolo, Count(contenuto_carrelli.idprodotto) 
    AS piùVenduti
    FROM contenuto_carrelli 
    inner join prodotti on contenuto_carrelli.idprodotto = prodotti.idprodotto 
    GROUP BY idprodotto 
    ORDER BY piùVenduti DESC;";
    ...
    if($result-> num_rows > 0) {
        ...
        echo "<thead class=\"thead-dark \">";
        echo "<tr>";
        echo "<th scope=\"col\">Id Prodotto </th>";
        echo "<th scope=\"col\">Prodotti più venduti </th>";
